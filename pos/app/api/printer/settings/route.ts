...
export async function GET(req: Request) {
  ...
  try {
    const data = await apiRequest('/pos/printer/settings', { bearer, terminalCode, deviceFingerprint });
...
export async function PUT(req: Request) {
  ...
  try {
    ...
    const data = await apiRequest('/pos/printer/settings', { method: 'PUT', bearer, terminalCode, deviceFingerprint, body });
